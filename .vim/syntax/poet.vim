...
" Statements
syn keyword     ptStatement     BREAK CONTINUE BREAK RETURN
...
syn keyword     ptOperator      REPLACE REBUILD COPY INSERT CLEAR ERASE
syn keyword     ptOperator      PERMUTE
syn keyword     ptOperator      CLEAR ERASE
syn keyword     ptOperator      LEN
syn keyword     ptOperator      ERROR PRINT DEBUG
syn keyword     ptOperator      TAIL HEAD

" Functions
syn keyword     ptFunction      car cdr cond
...
syn keyword     ptType          Char String FileName Comment UnknownUntilEOL
                              \ Name NameList NameOrStringList ExpList
syn keyword     ptType          Bop Uop ExpStmt FunctionCall ArrayAccess Macro TypeDef
                              \ Type Loop Nest Assign If Else
                              \ Stmt StmtList StmtBlock
                              \ BaseType VoidType IntType IntegerType FloatType StructType EnumType UnionType
                              \ VariableWithAnnot VarDecl VarDeclStmt
                              \ CallStmt NestIf NestDO NestLoop
...
" Macros
syn keyword     ptMacro         TOKEN KEYWORDS PARSE PREP UNPARSE NoParse BACKTRACK
syn keyword     ptMacro         PARSE_BOP PARSE_UOP PARSE_CALL PARSE_ARRAY
syn keyword     ptMacro         STMT_BASE C_STMT_BASE TYPE_BASE C_TYPE_BASE VAR_DECL
