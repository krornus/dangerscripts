...
" Editor settings
hi Normal        cterm=none      ctermbg=232 ctermfg=7  gui=none   guibg=#1E1E1E  guifg=#B0B0B0
...
hi LineNr        cterm=none      ctermbg=233  ctermfg=7  gui=none   guibg=#1E1E1E  guifg=#B0B0B0
hi CursorLineNR  cterm=none      ctermbg=236  ctermfg=0  gui=none   guibg=#A94744  guifg=#1E1E1E
...
hi Comment       cterm=none      ctermbg=0  ctermfg=172  gui=italic guibg=#1E1E1E  guifg=#608B4E
...
hi Macro         cterm=none     ctermbg=0  ctermfg=36  gui=none   guibg=#1E1E1E  guifg=#B06386
